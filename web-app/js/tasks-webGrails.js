	...
	return {
		...
		save : function(type, obj, successCallback, errorCallback) {
			...
			if(!obj.id)
			{
				...
				tipo="POST";
				url = "https://dfs6-projetofinal.herokuapp.com/task/save";
			...
			else
			{
				...
				url = "https://dfs6-projetofinal.herokuapp.com/task/update";
		...
		findAll : function(type, successCallback, errorCallback) {
			$.ajax({
			    ...
			    url: "https://dfs6-projetofinal.herokuapp.com/task/list",
			    dataType: "json",
			    type: "GET",
				processData: false,  // tell jQuery not to process the data
         		contentType: false,
		...
		delete : function(type, id, successCallback, errorCallback) {
			$.ajax({
			    ...
			    url: "https://dfs6-projetofinal.herokuapp.com/task/delete",
			    type: "DELETE",
		...
		findById : function (type, id, successCallback, errorCallback) {
			$.ajax({
			    ...
			    url: "https://dfs6-projetofinal.herokuapp.com/task/get/"+id,
