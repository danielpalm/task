		...
		<section id="taskCreation" class="not">
			<form id="taskForm">
				<div>
					...
					<label>Tarefa</label> 
					<input maxlength="200" type="text" required="required" name="task" id="task" class="large" placeholder="Estudar e programar" />
					
					
				</div>
				<div>
					<label>Finalizar até</label> <input type="date" required="required" id="requiredBy" name="requiredBy" />
				</div>
				<div>
